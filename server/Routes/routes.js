...
const stripe = require('stripe')('sk_test_51OysPDSGZT2Ip5VBZ1OeRmAHqW8yRTOtgiHnSFSS7ALmE9TkBHUFanR0vGC4UvdTwbJyGb2tyPom4WjfSxUDPwWz00u8HKQy8w');
const {housesModel,usersModel,enquiriesModel} = require("../models/allSchemas");

let upload=multer();

// const studentModel = require('../models/allSchemas');
